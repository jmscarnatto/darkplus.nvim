...
M.base = {
  ...
  Normal = { fg = c.red, bg = config.transparent_background and 'NONE' or c.bg },
  NormalFloat = { bg = c.dark },
  NormalNC = { fg = c.orange, bg = config.transparent_background and 'NONE' or c.bg },
  Number = { fg = c.yellow },
